...
?>
	...
	<footer id="colophon" class="site-footer navbar-fixed-bottom" role="contentinfo">
		<div class="container">
            <?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_id' => 'footer-menu', 'menu_class' => 'list-inline', 'container' => 'nav', 'container_class' => 'footer-nav pull-right', 'container_id' => 'main-navbar-collapse' ) ); ?>
